...
create table public.other_records (
  id uuid primary key default gen_random_uuid(),
...
create index on public.bike_sales (sale_date);
create index on public.bike_sales (customer_phone);
create index on public.bike_sales (chassis_number);
create index on public.due_records (due_date);
create index on public.due_records (payment_status);
create index on public.service_records (service_date);
create index on public.debit_transactions (transaction_date, category);
create index on public.credit_transactions (transaction_date, category);
